...
df1<-fread("data/source/geomedia/en_USA_latime_int.csv", encoding = "UTF-8")
df1$media<-"en_USA_latime"


df2<-fread("data/source/geomedia/en_USA_usatdy_int.csv", encoding = "UTF-8")
df2$media<-"en_USA_usatdy"
...
```{r dico pandemic}
# define keywords
label <- c("migrant*", "emigrant*", "immigrant*", "migrat*", "refug*", "asylum seeker*")
